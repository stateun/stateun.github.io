...
- **MIMIC-IV Dataset Description**  
  - Publicly available EHR dataset in which patient identifiers have been removed.  
...
1. **Treating AKI-Positive Patients as Anomalies**  
   Since patients who develop AKI can be considered a relatively rare group, they will be treated as anomalies.

2. **DeepSAD for Anomaly Detection**  
   We employ the **DeepSAD** approach to detect anomalies in the dataset, leveraging its ability to isolate and learn from minority cases effectively.
